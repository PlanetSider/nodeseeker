...
export class DatabaseMigrator {
  ...
  async runMigrations(): Promise<void> {
    ...
    try {
      ...
      // 读取迁移文件
      const migrationFiles = ['001_initial.sql', '002_add_rss_config.sql', '003_add_telegram_mode.sql', '004_add_feishu_config.sql', '005_add_keyword_strict_flags.sql', '006_add_rss_sources.sql', '007_add_ai_translation.sql'];
